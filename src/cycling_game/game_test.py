...
class Game:
    ...
    def __init__(self):
        ...
        self.spawn_delay = random.randint(500, 800)
        #Tourist Spawning
    ...
    def run(self):
        ...
        while True:    
            ...
            if self.spawn == True:
                if self.score < 1000:
                    weights = [1, 5, 3, 4, 4, 4, 2]
                else:
                    weights = [2, 4, 1, 7, 6, 7, 5]

                sprite_key = random.choices(["construction", "pothole", "tourist", "local", "bikestand", "local_right", "escooter"], weights = weights)[0]
                lanes = [350, 340, 400]
